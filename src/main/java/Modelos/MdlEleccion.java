...
public class MdlEleccion {
    ...
    public ClsMensaje agregarEleccion(ClsEleccion eleccion) {
        ...
        try {
            ...
            mensaje = new ClsMensaje(ClsMensaje.ERROR, "Error");
            return mensaje;

        } catch (Exception excepcion) {

            mensaje = new ClsMensaje(ClsMensaje.ERROR, "Error: " + excepcion.getMessage());
            return mensaje;
        }
...
public ClsMensaje actualizarEleccion(ClsEleccion eleccion) {
        ...
        try {
            ...
            String sql = "UPDATE tbl_elecciones SET descripcion = ?, categoria = ? WHERE id_eleccion = ?";
            ...
            sentencia.setString(3, eleccion.getIdEleccion());
